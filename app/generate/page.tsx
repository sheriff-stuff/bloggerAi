                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <TooltipProvider>
                          <Tooltip>
                            ...
                            <TooltipContent>
                              <p className="max-w-xs">
                                Our AI will generate relevant images to accompany your blog post
                              </p>
                            </TooltipContent>
                          </Tooltip>
                        </TooltipProvider>
                      ...
                      {formData.autoPost && (
                        <div className="p-4 bg-muted rounded-lg mt-2">
                          <p className="text-sm flex items-center">
                            ...
                            {formData.platform === "manual" ? "publishing platform" : formData.platform} in the
                            dashboard after generating your first blog.
                          </p>
                        </div>
                      )}
                    </TabsContent>
